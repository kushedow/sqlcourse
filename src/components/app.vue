...
<template>
  ...
  <div class="container mx-auto md:mt-6 p-4 md:p-8 rounded-xl bg-white   2xl:w-1/2 xl:w-2/3 ">
    ...
    <div v-if="status == 'loading'" class="status text-center">
        ...
        <svg aria-hidden="true" class="inline-block w-15 h-15 text-gray-200 animate-spin fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
